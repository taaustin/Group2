...
def cluster(mapType = "districts"):
    ...
    if(mapType == "districts"):
        ziprender.colorByDistrict(output, ziprender.randomColors(10, max=200))
    else:
        ziprender.colorByZip(output, ziprender.randomColors(10, max=200))
